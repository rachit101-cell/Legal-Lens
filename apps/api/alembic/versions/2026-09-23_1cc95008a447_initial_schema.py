...
def upgrade() -> None:
    ...
    sa.Column('status', postgresql.ENUM('QUEUED', 'RUNNING', 'COMPLETED', 'PARTIAL', 'FAILED', name='analysis_status_enum'), nullable=False),
    ...
    sa.Column('role', postgresql.ENUM('USER', 'ASSISTANT', 'SYSTEM', name='message_role_enum'), nullable=False),
    sa.Column('content', sa.String(), nullable=False),
    sa.Column('answer_status', postgresql.ENUM('SUPPORTED', 'PARTIALLY_SUPPORTED', 'UNSUPPORTED', 'UNVERIFIED', name='answer_status_enum'), nullable=True),
    ...
    sa.Column('status', postgresql.ENUM('PENDING', 'IN_PROGRESS', 'COMPLETED', 'NOT_APPLICABLE', name='checklist_status_enum'), nullable=False),
    ...
    op.create_index(op.f('ix_checklist_items_analysis_id'), 'checklist_items', ['analysis_id'], unique=False)
    op.create_index(op.f('ix_checklist_items_document_id'), 'checklist_items', ['document_id'], unique=False)
    ...
    sa.Column('support_status', postgresql.ENUM('SUPPORTED', 'PARTIALLY_SUPPORTED', 'UNSUPPORTED', 'UNVERIFIED', name='support_status_enum'), nullable=False),
    ...
    sa.Column('clause_type', postgresql.ENUM('PAYMENT_FEES', 'TERM_RENEWAL', 'TERMINATION_NOTICE', 'LIABILITY_INDEMNITY', 'CONFIDENTIALITY_IP', 'NON_COMPETE_NON_SOLICIT', 'DISPUTE_GOVERNING_LAW', 'PRIVACY_DATA', 'BOILERPLATE', 'MISCELLANEOUS', 'OTHER', name='clause_type_enum'), nullable=False),
    ...
    sa.Column('status', postgresql.ENUM('UPLOADING', 'QUEUED', 'VALIDATING', 'EXTRACTING', 'ANALYZING', 'INDEXING', 'GENERATING', 'VERIFYING', 'COMPLETED', 'PARTIAL', 'FAILED', 'DELETED', name='document_status_enum'), nullable=False),
    sa.Column('document_type', postgresql.ENUM('LEGAL_NOTICE', 'LEASE_AGREEMENT', 'EMPLOYMENT_AGREEMENT', 'SERVICE_AGREEMENT', 'NON_DISCLOSURE_AGREEMENT', 'PURCHASE_AGREEMENT', 'POWER_OF_ATTORNEY', 'COURT_ORDER', 'INVOICE', 'OTHER', name='document_type_enum'), nullable=True),
    ...
    sa.Column('entity_type', postgresql.ENUM('DATE', 'MONEY', 'PERCENTAGE', 'DURATION', 'NOTICE_PERIOD', 'CLAUSE_NUMBER', 'STATUTE_REFERENCE', 'PERSON', 'ORGANIZATION', 'ADDRESS', name='entity_type_enum'), nullable=False),
    ...
    sa.Column('char_start', sa.BigInteger(), nullable=True),
    sa.Column('char_end', sa.BigInteger(), nullable=True),
    sa.Column('extraction_method', postgresql.ENUM('REGEX', 'NER', 'RULE', 'LLM', name='extraction_method_enum'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.Column('char_end', sa.BigInteger(), nullable=True),
    sa.Column('bbox', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('source_type', postgresql.ENUM('USER_DOCUMENT', 'AI_GENERATED', 'EXTERNAL_SOURCE', name='source_type_enum'), nullable=False),
    sa.Column('verification_status', postgresql.ENUM('VERIFIED', 'OCR_APPROXIMATE', 'REJECTED', 'PENDING', name='verification_status_enum'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.Column('document_id', sa.String(), nullable=False),
    sa.Column('analysis_id', sa.String(), nullable=False),
    sa.Column('category', postgresql.ENUM('FINANCIAL', 'COMMITMENT', 'LIABILITY', 'TERMINATION', 'CONSISTENCY', 'MISSING_INFORMATION', 'DEADLINE', 'OTHER', name='finding_category_enum'), nullable=False),
    sa.Column('severity', postgresql.ENUM('IMPORTANT', 'NEEDS_REVIEW', 'ATTENTION_REQUIRED', 'INFORMATION_MISSING', name='severity_enum'), nullable=False),
    ...
    sa.Column('page_number', sa.BigInteger(), nullable=False),
    sa.Column('text', sa.String(), nullable=False),
    sa.Column('text_source', postgresql.ENUM('NATIVE_TEXT', 'OCR', 'MIXED', name='text_source_enum'), nullable=False),
    ...
    sa.Column('document_id', sa.String(), nullable=False),
    sa.Column('analysis_id', sa.String(), nullable=False),
    sa.Column('event_type', postgresql.ENUM('START_DATE', 'END_DATE', 'DEADLINE', 'NOTICE_PERIOD', 'PAYMENT_DUE', 'RENEWAL_WINDOW', 'TERMINATION_WINDOW', 'RESPONSE_DEADLINE', 'OTHER', name='timeline_event_type_enum'), nullable=False),
    sa.Column('label', sa.String(), nullable=False),
    sa.Column('date_value', sa.String(), nullable=True),
    sa.Column('duration_days', sa.BigInteger(), nullable=True),
    sa.Column('date_status', postgresql.ENUM('EXPLICIT', 'EXTRACTED', 'DERIVED', 'INFERRED', name='date_status_enum'), nullable=False),
    ...
    op.create_index(op.f('ix_timeline_events_analysis_id'), 'timeline_events', ['analysis_id'], unique=False)
    op.create_index(op.f('ix_timeline_events_document_id'), 'timeline_events', ['document_id'], unique=False)
